...
export default function BroncoRules(props) {
	return (
		<Container>
			<Header as='h1' textAlign='center'>Bronco Rules for 2019</Header>

			<p>For any questions, contact the <a href='mailto:daguayo82@yahoo.com'>Bronco Division Coordinator</a>.</p>
			...
			<List>
				<List.Item>
					...
					<List.Content>
						...
						<List.Description>
							Games will drop dead at 2 hours. No new inning can begin after 1 hour and 50 minutes. Games will also end if 7 innings are completed. Whichever comes first. 
						</List.Description>
					</List.Content>
				</List.Item>
				<List.Item>
					...
					<List.Content>
						...
						<List.Description>
							The pitching distance is 50' from the tip of home plate to the front of the pitching rubber. Base distance is 70'.
						</List.Description>
					</List.Content>
				</List.Item>
				<List.Item>
					...
					<List.Content>
						...
						<List.Description>
							All players are required to a wear a cup, girls recommended. Only metal cleats are allowed on pitching mounds. 
						</List.Description>
					</List.Content>
				</List.Item>
				<List.Item>
				...
				<List.Item>
					...
					<List.Content>
						...
						<List.Description>
							Maximum of 5 runs per inning. The 6th and 7th inning will have a maximum of 10 runs allowed.
						</List.Description>
					</List.Content>
				</List.Item>
				<List.Item>
				...
				<List.Item>
					...
					<List.Content>
						...
						<List.Description>
							All MLB rules apply unless otherwise stated. Bunts allowed, stealing, lead-offs, drop 3rd strike, infield fly, balks.
						</List.Description>
					</List.Content>
				</List.Item>
				<List.Item>
